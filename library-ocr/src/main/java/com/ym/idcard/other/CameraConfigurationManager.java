...
final class CameraConfigurationManager {
	...
	private static Point getCameraResolution(Parameters paramParameters, Point paramPoint) {
	...
	private void setFlash(Parameters paramParameters) {
		// if ((Build.MODEL.contains("Behold II")) && (CameraManager.SDK_INT ==
		// 3))
	...
	private void setZoom(Parameters paramParameters) {
