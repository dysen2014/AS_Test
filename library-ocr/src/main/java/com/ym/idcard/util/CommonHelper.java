...
public class CommonHelper {
	public static class Device {
		...
		public static String getLocalIpAddress(Context paramContext) {
			try {
				...
				if (localEnumeration1.hasMoreElements()) {
					Enumeration localEnumeration2 = ((NetworkInterface) localEnumeration1.nextElement())
							.getInetAddresses();
		...
		public static String getLocalMacAddress(Context paramContext) {
			return ((WifiManager) paramContext.getSystemService(Context.WIFI_SERVICE)).getConnectionInfo()
					.getMacAddress();
		}
		...
		public static class Screen {
			...
			public static double getSize(Activity paramActivity) {
				...
				Log.d("SCREEN", "screenWidth:" + i + ",screenHeight:" + j + ",densityDpi" + k);
				return d;
			}
			...
			public static boolean isHorizontal(Context paramContext) {
				int mCurrentOrientation = paramContext.getResources().getConfiguration().orientation;
	...
	public static class Msg {
		...
		public static void sendMsg(Handler paramHandler, int paramInt, Integer paramInteger) {
		...
		public static void sendMsg(Handler paramHandler, int paramInt, Object paramObject) {
			Message localMessage = new Message();
			localMessage.what = paramInt;
			if (paramObject != null)
		...
		public static void sendMsg(Handler paramHandler, int paramInt, Object paramObject, Integer paramInteger) {
			Message localMessage = new Message();
			localMessage.what = paramInt;
			localMessage.obj = paramObject;
			if (paramInteger != null)
		...
		public static void sendMsg(Handler paramHandler, int paramInt, String paramString) {
			Message localMessage = new Message();
			localMessage.what = paramInt;
			if (paramString != null)
		...
		public static void sendMsg(Handler paramHandler, int paramInt, String paramString, Integer paramInteger) {
			Message localMessage = new Message();
			localMessage.what = paramInt;
			if (paramString != null)
				localMessage.obj = paramString;
		...
		public static void showShortText(Context paramContext, int paramInt) {
			Toast.makeText(paramContext, Resource.getString(paramContext, paramInt), 0).show();
		}

		public static void showShortText(Context paramContext, String paramString) {
	...
	public static class Path {
		public static String getBaseFull() {
			String str = getSdCard() + BaseProperties.getProperty("store_location", "base") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getBaseImagesFull() {
			String str = getBaseFull() + BaseProperties.getProperty("images_store_location", "images") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getBaseLogFull() {
			String str = getBaseFull() + BaseProperties.getProperty("log_file_folder", "logs") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getBaseUpdateFull() {
			String str = getBaseFull() + BaseProperties.getProperty("update_file_folder", "base") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getBaseWebCacheFull() {
			String str = getBaseFull() + BaseProperties.getProperty("web_cache_location", "webcache") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getBizFull() {
			String str = getBaseFull() + BaseProperties.getProperty("biz_location", "biz") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getConfigFull() {
			String str = getBaseFull() + BaseProperties.getProperty("conf_folder", "config") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}
		...
		public static String getDownloadPackageWebCacheFull() {
			String str = getBaseWebCacheFull()
					+ BaseProperties.getProperty("download_package_cache_location", "downloadpackage") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getElePicFull() {
			String str = getBizFull() + BaseProperties.getProperty("elePic_location", "elePic") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getEleSignFull() {
			String str = getBizFull() + BaseProperties.getProperty("eleSign_location", "eleSign") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getIdCardFull() {
			String str = getBaseFull() + BaseProperties.getProperty("idcard_location", "idcard") + File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}

		public static String getIdCardWebCacheFull() {
			String str = getBaseWebCacheFull() + BaseProperties.getProperty("idcard_cache_location", "idcard")
					+ File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}
		...
		public static String getMennuImageWebCacheFull() {
			String str = getBaseWebCacheFull() + BaseProperties.getProperty("menu_image_cache_location", "menuimage")
					+ File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}
		...
		public static String getOfferImageWebCacheFull() {
			String str = getBaseWebCacheFull() + BaseProperties.getProperty("offer_image_cache_location", "offerimages")
					+ File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}
		...
		public static String getPrintConfigFileWebCacheFull() {
			return getPrintConfigWebCacheFull()
					+ BaseProperties.getProperty("print_config_file_name", "bt_idcreader_name2class.properties");
		}

		public static String getPrintConfigWebCacheFull() {
			String str = getBaseWebCacheFull() + BaseProperties.getProperty("print_config_cache_location", "print")
					+ File.separator;
			FileCommon.mkdirWithFullName(str);
			return str;
		}
		...
		public static String getSdCard() {
			...
			return localFile.getParent() + File.separator + localFile.getName() + File.separator;
		}
	}

	public static class Resource {
		public static String getArrayString(Context paramContext, int paramInt1, int paramInt2) {
	...
	public static AppInfo getThatInfo(Context paramContext, String paramString) {
		...
		try {
			...
			localAppInfo.appname = localPackageInfo.applicationInfo.loadLabel(paramContext.getPackageManager())
					.toString();
			...
			localAppInfo.icon = localPackageInfo.applicationInfo.loadIcon(paramContext.getPackageManager());
			return localAppInfo;
