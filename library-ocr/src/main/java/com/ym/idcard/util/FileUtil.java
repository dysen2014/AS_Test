...
public class FileUtil {
	...
	public static String getStrFromFile(File file) throws IOException {
		...
		BufferedReader localBufferedReader = new BufferedReader(new InputStreamReader(is, "GBK"));
		String str1 = null;
...
/*
 * Location:
 * D:\document\bsd_work\�?体机资料\测试app\com.newland.activity\classes_dex2jar.jar
