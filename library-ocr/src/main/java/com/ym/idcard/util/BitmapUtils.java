...
public class BitmapUtils {
	...
	public static Bitmap generatorBitmapWithNum(Bitmap paramBitmap, int paramInt) {
		...
		localCanvas.drawBitmap(paramBitmap, new Rect(0, 0, paramBitmap.getWidth(), paramBitmap.getHeight()),
				new Rect(0, j, paramBitmap.getWidth(), i - 5), localPaint1);
		Paint localPaint2 = new Paint(257);
		localPaint2.setColor(-1);
		localPaint2.setTextSize(14.0F);
		localPaint2.setTextAlign(Align.CENTER);
	...
	public static Bitmap mergeBitmap(Bitmap paramBitmap1, Bitmap paramBitmap2) {
		...
		Bitmap localBitmap = Bitmap.createBitmap(paramBitmap1.getWidth(), paramBitmap1.getHeight(),
				Config.ARGB_8888);
		Canvas localCanvas = new Canvas(localBitmap);
		localCanvas.drawBitmap(paramBitmap1, 0.0F, 0.0F, localPaint);
		localCanvas.drawBitmap(paramBitmap2, paramBitmap1.getWidth() - paramBitmap2.getWidth(),
				paramBitmap1.getHeight() - paramBitmap2.getHeight(), localPaint);
		return localBitmap;
	}
}