...
public class LoanAfter extends Fragment {
...
//        Log.i("boolean", String.valueOf(aBoolean));
        new LoanAfter.HttpThread().sendRequestWithOkHttp("http://192.168.1.100:9080/ALS7M/JSONService?method=crmLoanAfter",jsonObject);
        handler = new Handler() {
            @Override
