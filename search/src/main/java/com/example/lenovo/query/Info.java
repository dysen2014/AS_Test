...
//        inflater = LayoutInflater.from(context);
        ...
        listView = (ListView) v.findViewById(R.id.listViewInfo);
...
//        bundle.putString("CustomerType","030");
        ...
        new Info.HttpThread().sendRequestWithOkHttp("http://192.168.1.100:9080/ALS7M/JSONService?method=crmCustomerInfo",jsonObject);
        handler = new Handler() {
            @Override
            public void handleMessage(Message msg) {
                ...
                if (msg.obj != null) {
                    final List<ListInfo> list = (List<ListInfo>) msg.obj;
...
//                Log.i("","listView:"+listView+"\tlist size:"+keymanItem.size());
                    listView.setAdapter(new MyAdaptorInfo(mContext, InfoItem,customerType));
                }
            }
        };
        return v;
...
//                }
                ...
                Gson gson = new Gson();
                List<ListInfo> customerList = gson.fromJson(jsonArray, new TypeToken<List<ListInfo>>(){}.getType());
