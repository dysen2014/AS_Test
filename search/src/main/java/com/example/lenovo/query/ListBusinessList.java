...
public class ListBusinessList {
    ...
    public String getBusinessSum(){ return BusinessSum; }
    public void setBusinessSum(String BusinessSum){ BusinessSum = BusinessSum; }
    public String getBalance(){ return Balance; }
    public void setBalance(String Balance){ Balance = Balance; }
    public String getOverDueBalance(){ return OverDueBalance; }
    public void setOverDueBalance(String OverDueBalance){ OverDueBalance = OverDueBalance; }
    public String getInterestBalance(){ return InterestBalance; }
    public void setInterestBalance(String InterestBalance){ InterestBalance = InterestBalance; }
    ...
    public void setTypeNo(String TypeNo){ TypeNo = TypeNo; }
    public String getContractNo(){ return ContractNo; }
    public void setContractNo(String ContractNo){ ContractNo = ContractNo; }
}
