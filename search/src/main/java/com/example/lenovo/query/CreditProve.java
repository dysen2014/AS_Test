...
public class CreditProve extends Fragment {
...
//        bundle.putString("CustomerType","030");
        ...
        new CreditProve.HttpThread().sendRequestWithOkHttp("http://192.168.1.100:9080/ALS7M/JSONService?method=crmCreditProve",jsonObject);
        handler = new Handler() {
            @Override
