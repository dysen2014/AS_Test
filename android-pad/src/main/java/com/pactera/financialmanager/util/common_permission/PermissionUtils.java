...
public class PermissionUtils {
    ...
    private static String mRationaleTitle;
    private static String mPositiveText = "确定";
    private static String mNegativeText = "取消";
    ...
    private PermissionUtils(@NonNull Object object) {
    ...
    public static PermissionUtils with(@NonNull android.app.Fragment fragment) {
        return new PermissionUtils(fragment);
    }

    public PermissionUtils permissions(@NonNull String... permissions) {
    ...
    public PermissionUtils requestCode(int requestCode) {
        mRequestCode = requestCode;
        return this;
    }

    public PermissionUtils rationaleTitle(String title) {
        mRationaleTitle = title;
        return this;
    }

    public PermissionUtils positiveText(String positiveText) {
        mPositiveText = positiveText;
        return this;
    }

    public PermissionUtils negativeText(String negativeText) {
        mNegativeText = negativeText;
        return this;
    }

    public PermissionUtils isDebug(boolean isDebug) {
        sDebug = isDebug;
        return this;
    }
    ...
    public void request(Object object, int requestCode, String... permissions) {
        if (needRequest() && notGrantedAllPermissions(getActivity(object), permissions)) {
            ...
            LogUtils.d("request---" + "requestCode : " + requestCode + "---unGrantedPermissionsList : " + unGrantedPermissionsList);
            ...
            LogUtils.d("request---" + "requestCode : " + requestCode + "---permissionsGranted : " + stringArrayToList(permissions));
            invokePermissionsGranted(object, requestCode, permissions);
        }
    }
    ...
    private void requestPermissions(Object object, int requestCode, String... permissions) {
        LogUtils.d("requestPermissions---" + "requestCode : " + requestCode + "---requestPermissions : " + stringArrayToList(permissions));
     ...
     * @return
     */
    private static void showAlertDialog(final Object object, final int requestCode, final String... deniedPermissions) {
        LogUtils.d("showAlertDialog --- " + "requestCode : " + requestCode + "--- deniedPermissions : " + stringArrayToList(deniedPermissions));
    ...
    private static void dealDeniedPermissions(Object object, int requestCode, String... deniedPermissions) {
        LogUtils.d("dealDeniedPermissions --- " + "requestCode : " + requestCode + "--- deniedPermissions : " + stringArrayToList(deniedPermissions));
    ...
    private static List<String> stringArrayToList(String[] strings) {
    ...
    private static String createRationaleMsg(Context context, String... permissions) {
    ...
    private static String createPermissionsMsg(String... permissions) {
    ...
    private static IPermissionsCallback getPermissionsCallback(Object object) {
        return (IPermissionsCallback) object;
    }

    private static void invokePermissionsGranted(Object object, int requestCode, String... permissions) {
        getPermissionsCallback(object).onPermissionsGranted(requestCode, permissions);
    }

    private static void invokePermissionsDenied(Object object, int requestCode, String... permissions) {
    ...
    public static void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == mRequestCode) {
            ...
            LogUtils.d("onRequestPermissionsResult--- " + "requestCode : " + requestCode + "--- deniedPermissions : " + deniedPermissions);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == SETTINGS_REQ_CODE) {
            ...
            LogUtils.d("onActivityResult --- " + "requestCode : " + requestCode + "---" + "unGrantedPermissionsList : " + unGrantedPermissionsList);
            if (unGrantedPermissionsList.size() > 0) {
    ...
    private static void goSetting(Object object) {
        LogUtils.d("goSetting");
