...
public class QuitAppDialog extends Dialog implements View.OnClickListener {
	...
	public QuitAppDialog(Context context, int layoutId, int linearId,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt_YES = (TextView) QuitAppDialog.this.findViewById(btnYesId);
		bt_NO = (TextView) QuitAppDialog.this.findViewById(btnNoId);
	...
	public void onClick(View v) {
		...
		if (id == btnYesId) {
			...
			if (ParentActivity.activityList.size() > 0) {
				for (Activity activity : ParentActivity.activityList) {
