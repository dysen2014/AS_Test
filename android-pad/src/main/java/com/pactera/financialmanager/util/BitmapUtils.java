...
public class BitmapUtils {
	...
	public static void getPictureFromCamera(Activity activity) {
		...
		activity.startActivityForResult(intent, Constants.TAKE_PICTURE_FROM_CAMERA);
	}
	...
	public static void getPictureFromPhotoAlbum(Activity activity) {
		...
		activity.startActivityForResult(intent, Constants.TAKE_PICTURE_FROM_PHOTO_ALBUM);
	}
	...
	public static void deletePic(Activity activity) {
		...
		data.putString("value", "" + Constants.PHOTO_DELETE);
		msg.setData(data);
	 ...
	 * 
	 */
	public static void startPhotoZoom(Activity activity, Uri fromFile, int aspectX,
			int aspectY, int width, int height) {
		...
		activity.startActivityForResult(intent, Constants.PHOTO_ZOOM);
	}
