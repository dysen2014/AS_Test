...
public class CheckUpdateAppDialog extends Dialog implements
	...
	public CheckUpdateAppDialog(Context context, int layoutId, int linearId,
	...
	public CheckUpdateAppDialog(Context context) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt_YES = (TextView) CheckUpdateAppDialog.this.findViewById(btnYesId);
		bt_NO = (TextView) CheckUpdateAppDialog.this.findViewById(btnNoId);
