 ...
 * 
 */
public class SigninFragment extends ParentFragment implements OnClickListener {
...
//	private TextView signinInfo;// 当前地址信息
	...
	private static String LocStr;// 当前地址
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		conView = inflater.inflate(R.layout.fragmentmysignin, null);
		...
		mBaiduMap.setMyLocationConfigeration(new MyLocationConfiguration(LocationMode.NORMAL, false, MarkerBitmap));
		...
		mBaiduMap.setOnMyLocationClickListener(new OnMyLocationClickListener() {
			OnInfoWindowClickListener OnInfoWindowListter;
			@Override
			public boolean onMyLocationClick() {
				LatLng llNew = new LatLng(ll.latitude + 0.0005,ll.longitude + 0.0005);
				OnInfoWindowListter = new OnInfoWindowClickListener() {
					@Override
...
//				infoWindow = new InfoWindow(BitmapDescriptorFactory.fromView(signinView), llNew, -30, OnInfoWindowListter);
		...
		mBaiduMap.setOnMapClickListener(new OnMapClickListener() {
			...
			public boolean onMapPoiClick(MapPoi arg0) {
				...
				Toast.makeText(getActivity(), arg0.getName(),
...
//点击提交
	private void setData() {
		...
		if (content.equals("")){
			ShowDialog(getActivity(), "签到内容不能为空！！！");
		}else{
...
//				content.replace("\r\n", "");
			...
			HCon = RequestInfo(this, requestType.Other, InterfaceInfo.Signin_Creat, newRecord.toString(), returnIndex);
		}
	}
}
