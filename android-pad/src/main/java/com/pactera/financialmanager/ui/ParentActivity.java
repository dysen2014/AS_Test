...
public class ParentActivity extends FragmentActivity {
    ...
    public static IDCardResult idCard = null;
    ...
    public static class MyUtils{
        ...
        public static void setSelItemColor(View view, @ColorInt @ColorRes @DrawableRes int
                colorId, @ColorInt @ColorRes @DrawableRes int oldColorId) {
         ...
         * @param tvHideData
         */
        public static void initLoad(List<BeanHeader> mListTop, List<List<String>> mListData, TextView
                tvHideData, TextView leftTopItemTv) {
//            mListData.clear();
//            mListTop.clear();
                leftTopItemTv.setText("");
            WarnActivity.layBacks.setVisibility(View.INVISIBLE);
            if (tvHideData!=null)
...
//		StatusBarUtil.setTranslucentDiff(this);
    ...
    protected void openOCR() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ...
            Intent intent = new Intent(this, IDCardInfoReaderActivity.class);
...
//                    ShowDialog(this, str);
    ...
    private void setValue(IDCardResult idCard, EditText customerName, EditText cardNumber) {
        ...
        if (idCard != null) {
            ...
            ViewUtils.setViewsValue(java.util.Arrays.asList(new View[]{customerName, cardNumber}), java.util.Arrays
                    .asList(new String[]{getString(R.string.hint_cus_name), getString(R.string.hint_card_num)}));
            toast("身份证信息识别失败");
        }
    }
...
//		}
     ...
     * 有提示窗的弹窗
     */
    public void initTitle(final Activity activity, String title, boolean isPop, final String nameInfo) {
        ImageView backImg = (ImageView) findViewById(R.id.com_img_back);
        TextView tvTitle = (TextView) findViewById(R.id.com_title_tv);
        ImageView popis = (ImageView) findViewById(R.id.pop_is);
        TextView username = (TextView) findViewById(R.id.com_tv_adminname);
        TextView out = (TextView) findViewById(R.id.com_tv_out);

        if (isPop){
            if (popis != null) {
                popis.setBackgroundResource(R.drawable.question_mark_prompt);
    ...
    private void Showdilog(String nameInfo ){

        View view = LayoutInflater.from(this).inflate(R.layout.transparent_dilog, null);
        TextView detailText = (TextView) view.findViewById(R.id.details_dilog);
        detailText.setText(nameInfo);
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(this,R.style.DialogTheme);
     ...
     * 请求同样方式
     *
     * @param context     请求的Fragment
     * @param requestType 请求类型
     * @param requestCode 接口
     * @param info        请求实体内容
     * @param Index       返回index
     */
    ...
    public HConnection RequestInfo(ParentActivity context,
                                   Constants.requestType requestType, String requestCode, String info,
                                   int Index, boolean isShow, String brCode) {
        HConnection HCon = null;
        if (Tool.haveNet(this)) {
            String requestHttp = Tool.requestHttp(requestCode, "getJSON", brCode);
            switch (requestType) {
                case Search:
                case Delete:
                    requestHttp = requestHttp + "&spareOne=" + info;
    ...
    public HConnection RequestInfo(ParentActivity context,
                                   Constants.requestType requestType, String requestCode, String info,
                                   int Index, String brCode) {
        return RequestInfo(context, requestType, requestCode, info, Index, true, brCode);
    }
...
//		recyclerView.addItemDecoration(new TestDecoration(this));
    ...
    public QBadgeView setBadgeView(Context context, View view, String text) {
    ...
    public static int isBackground() {
        if (MyApplication.stateCount == 0) {//后台
            return 0;
        } else {//前台
            return 1;
        }
