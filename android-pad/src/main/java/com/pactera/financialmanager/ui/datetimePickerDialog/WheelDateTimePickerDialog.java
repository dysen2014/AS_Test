package com.pactera.financialmanager.ui.datetimePickerDialog;
 ...
 */
public class WheelDateTimePickerDialog extends AlertDialog implements
		OnClickListener {
	...
	public WheelDateTimePickerDialog(Context context, final int START_YEAR,
		...
		View view = inflater.inflate(R.layout.wheel_timelayout, null);
