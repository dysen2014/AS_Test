...
public class BusinessTypeBg extends ParentActivity {
...
//        Bundle bundle = getArguments();
        ...
        new HttpThread().sendRequestWithOkHttp("http://192.168.1.100:9080/ALS7M/JSONService?method=businessType",jsonObject);
        handler = new Handler() {
            @Override
