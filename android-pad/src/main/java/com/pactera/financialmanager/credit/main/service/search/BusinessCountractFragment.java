...
//        inflater = LayoutInflater.from(context);
        ...
        Bundle bundle = BusinessDetails.bundle;
...
//        customerType = (String) bundle.get("CustomerType");
        ...
        new HttpThread().sendRequestWithOkHttp("http://192.168.1.100:9080/ALS7M/JSONService?method=crmBusinessCountract",jsonObject);
        handler = new Handler() {
            @Override
