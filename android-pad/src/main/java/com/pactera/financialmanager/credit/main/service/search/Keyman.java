...
//        bundle.putString("CustomerType","030");
        ...
        new HttpThread().sendRequestWithOkHttp("http://192.168.1.100:9080/ALS7M/JSONService?method=crmEntKeyman",jsonObject);
        handler = new Handler() {
            @Override
...
//                        JSONObject t = responseData;
        ...
        private Object parseJSONWithGson(String jsonData) throws JSONException {
            if (!TextUtils.isEmpty(jsonData) || jsonData != null){
                ...
                Log.d("tag10", jsonHeader+"jsonObject: " + jsonArray);
                Gson gson = new Gson();
