 ...
 */
package com.pactera.financialmanager.database.utils;

import com.pactera.financialmanager.database.annotate.Id;
import com.pactera.financialmanager.database.annotate.ManyToOne;
import com.pactera.financialmanager.database.annotate.OneToMany;
import com.pactera.financialmanager.database.annotate.Property;
import com.pactera.financialmanager.database.annotate.Transient;
    ...
    public static Field getFieldByColumnName(Class<?> clazz, String columnName) {
        ...
        if (columnName != null) {
            ...
            if (fields != null && fields.length > 0) {
                ...
                if (field == null) {
                    for (Field f : fields) {
                        com.pactera.financialmanager.database.annotate.Property property = f.getAnnotation(Property.class);
                        if (property != null
