...
import com.pactera.financialmanager.database.ManyToOneLazyLoader;
import com.pactera.financialmanager.database.annotate.Id;
import com.pactera.financialmanager.database.annotate.Table;
...
public class ClassUtils {
    ...
    public static String getPrimaryKeyColumn(Class<?> clazz) {
        ...
        if (fields != null) {
            com.pactera.financialmanager.database.annotate.Id idAnnotation = null;
            Field idField = null;
