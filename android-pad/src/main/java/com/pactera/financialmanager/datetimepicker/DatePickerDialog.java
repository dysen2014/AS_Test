...
import com.pactera.financialmanager.util.DateUtil;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
        ...
        mDoneButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                tryVibrate();
                if (mCallBack != null) {
                    mCallBack.onDateSet(mCalendar.get(Calendar.YEAR) + "", DateUtil.formatNum(mCalendar.get(Calendar.MONTH) + 1 + ""), DateUtil.formatNum(mCalendar.get(Calendar.DAY_OF_MONTH) + ""));
                }
                dismiss();
            }
        });
...
//		}
    ...
    public static abstract interface OnDateSetListener {
        public abstract void onDateSet(String year, String month, String day);
    }
}