...
public class StudyActivity$$ViewBinder<T extends com.pactera.financialmanager.credit.main.service.study.StudyActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131298248, "field 'shvSearch'");
    target.shvSearch = finder.castView(view, 2131298248, "field 'shvSearch'");
