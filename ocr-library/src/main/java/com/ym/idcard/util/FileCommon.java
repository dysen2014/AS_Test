...
public class FileCommon {
	...
	private static int getNextSize(byte[] line) {
		...
		int len = line.length;
		if (len <= 6 && len > 2 && line[len - 2] == '\r' && line[len - 1] == '\n') {
	...
	public static void mkdirWithFullName(String fullPath) {
		...
		if ((tag == -1) || (tag == 0))
			return;
		File localFile = new File(fullPath.substring(0, fullPath.lastIndexOf("/")));
		if (localFile.exists())
			return;
		localFile.mkdirs();
	}
	...
	public static String readFileToString(String paramString1, String paramString2) throws IOException {
	...
	public static byte[] readInputStreamToByte(InputStream paramInputStream) throws IOException {
		ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream();
		byte[] arrayOfByte = new byte[20480];
		while (true) {
	...
	// ERROR //
	public static void writeFileByAppend(String paramString1, String paramString2) {
		// Byte code:
		// 0: aconst_null
		// 1: astore_2
		// 2: aload_0
	...
	// ERROR //
	public static void writeFileByByte(String paramString, byte[] paramArrayOfByte) {
		// Byte code:
		// 0: aconst_null
		// 1: astore_2
		// 2: aload_0
	...
	// ERROR //
	public static void writeFileByInputStream(String paramString, InputStream paramInputStream) {
		// Byte code:
		// 0: aconst_null
		// 1: astore_2
		// 2: aload_1
